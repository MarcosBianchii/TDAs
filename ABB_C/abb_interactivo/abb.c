...
abb_t *abb_insertar(abb_t *arbol, void *elemento)
{
	...
	arbol->nodo_raiz = insertar_hoja(arbol, arbol->nodo_raiz, elemento);
	return arbol;	
}
/*
...
//	Solo puede ser NULL el puntero a elemento.
*/
static nodo_abb_t *quitar_nodo(abb_t *arbol, nodo_abb_t *raiz, void *elemento, void **borrado)
{
	if (!raiz)
		return NULL;
	...
	if (comparacion > 0)
		...
		*borrado = raiz->elemento;
		...
		if (izq && der){
			...
			raiz->izquierda = obtener_predecesor(raiz->izquierda, &nodo);
